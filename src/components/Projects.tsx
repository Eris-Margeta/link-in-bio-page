...
const projects = [
	{
		...
		icon: Lucide.IconExternalLink,
		url: "https://midnightapes.com",
	},
	{
		title: "Karma Chameleons",
		description: "NFT Collection",
		icon: Lucide.IconExternalLink,
		url: "https://www.karm4ch4meleons.lol",
	},
	{
		title: "404 Birds",
		description: "NFT Collection",
		icon: Lucide.IconExternalLink,
		url: "https://404birds.com",
	},
	{
		title: "Fükíÿú Token",
		description: "Coin on Solana",
		icon: Lucide.IconExternalLink,
		url: "https://www.fukiyu.lol",
	},
];
...
export default () => {
	return (
		<div>
			<h2 className="font-medium text-xl mb-3">Our Other Projects</h2>
